...
export default {
  ...
  methods: {
    salvarVaga() {
      ...
      //selecionamos a chave do registro por meio do método getItem('')
      //resgatando a string do localStorage
      ...
      //caso o formulário esteja com algum campo vazio ele cai no else e retorna
      //as propriedades com valores diferentes
      if (this.validaFormulario()) {
        //armazenndo o value do local storage de um objeto em formato de string
        //para isso utilizamos JSON.stringify que converte o objeto para sring
        localStorage.setItem('vagas', JSON.stringify(vagas))
        this.emitter.emit('alerta', {
          time: 8000,
          tipo: 'sucesso',
          titulo: `A vaga ${this.titulo} foi cadastrada com sucesso!`,
          descricao: 'Parabéns, a vaga foi cadastrada e poderá se consultada por milhares de profissionais em nossa plataforma'
        })
